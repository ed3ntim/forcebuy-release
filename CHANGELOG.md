...
- **The price page lists your items, not the catalogue.** On the server the
  price tables hold every name the daily passes touch - sixteen thousand of
  them - and the page showed all of them. It now shows the ones you hold.
